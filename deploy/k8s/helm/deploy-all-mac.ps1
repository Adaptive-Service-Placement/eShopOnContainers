...
$infras = ("sql-data", "nosql-data", "mysql", "rabbitmq", "keystore-data", "basket-data", "cluster-roles")
$charts = ("eshop-common", "basket-api","catalog-api", "identity-api", "mobileshoppingagg","ordering-api","ordering-backgroundtasks","ordering-signalrhub", "payment-api", "monitoring-service", "mapping-service", "webmvc", "webshoppingagg", "webspa", "webstatus", "webhooks-api", "webhooks-web")
