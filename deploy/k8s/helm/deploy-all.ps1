...
$charts = ("eshop-common", "basket-api","catalog-api", "identity-api", "mobileshoppingagg","ordering-api","ordering-backgroundtasks","ordering-signalrhub", "payment-api", "monitoring-service", "webmvc", "webshoppingagg", "webspa", "webstatus", "webhooks-api", "webhooks-web")
