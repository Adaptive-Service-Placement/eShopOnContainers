...
public record RandomOrderingPaymentEvent : IntegrationEvent 
{
    ...
    public RandomOrderingPaymentEvent(String eventId, List<int> listOfRandomNumbers, List<String> listOfRandomStrings) 
    {
        EventId = eventId;
