...
public class RandomCatalogPaymentEventHandler : IIntegrationEventHandler<RandomCatalogPaymentEvent>
{
    private readonly ILogger<RandomCatalogPaymentEventHandler> _logger;

    public RandomCatalogPaymentEventHandler(ILogger<RandomCatalogPaymentEventHandler> logger) 
    {
