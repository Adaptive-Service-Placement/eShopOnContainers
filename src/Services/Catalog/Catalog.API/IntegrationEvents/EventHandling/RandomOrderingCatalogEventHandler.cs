...
public class RandomOrderingCatalogEventHandler : IIntegrationEventHandler<RandomOrderingCatalogEvent> 
{
    private readonly ILogger<RandomOrderingCatalogEventHandler> _logger;

    public RandomOrderingCatalogEventHandler(ILogger<RandomOrderingCatalogEventHandler> logger) 
    {
        _logger = logger ?? throw new System.ArgumentNullException(nameof(logger));
    }

    public async Task Handle(RandomOrderingCatalogEvent @event) 
    {
