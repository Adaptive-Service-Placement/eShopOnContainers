...
public class RandomSignalCatalogEventHandler : IIntegrationEventHandler<RandomSignalCatalogEvent> 
{
    private readonly ILogger<RandomSignalCatalogEventHandler> _logger;

    public RandomSignalCatalogEventHandler(ILogger<RandomSignalCatalogEventHandler> logger) 
    {
        _logger = logger ?? throw new System.ArgumentNullException(nameof(logger));
    }

    public async Task Handle(RandomSignalCatalogEvent @event) 
    {
