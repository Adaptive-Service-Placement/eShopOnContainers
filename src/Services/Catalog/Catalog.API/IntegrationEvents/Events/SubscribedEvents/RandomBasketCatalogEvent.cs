...
public record RandomBasketCatalogEvent : IntegrationEvent {
    ...
    public RandomBasketCatalogEvent(String eventId, List<int> listOfRandomNumbers, List<String> listOfRandomStrings) 
    {
        EventId = eventId;
