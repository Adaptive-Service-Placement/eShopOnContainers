...
public record RandomCatalogWebhookEvent : IntegrationEvent 
{
    ...
    public RandomCatalogWebhookEvent(String eventId, List<int> listOfRandomNumbers, List<String> listOfRandomStrings) 
    {
        EventId = eventId;
