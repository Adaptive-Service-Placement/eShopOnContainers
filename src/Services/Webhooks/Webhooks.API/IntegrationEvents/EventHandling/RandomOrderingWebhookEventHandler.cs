...
public class RandomOrderingWebhookEventHandler : IIntegrationEventHandler<RandomOrderingWebhookEvent> 
{
    private readonly ILogger<RandomOrderingWebhookEventHandler> _logger;

    public RandomOrderingWebhookEventHandler(ILogger<RandomOrderingWebhookEventHandler> logger) 
    {
        _logger = logger ?? throw new System.ArgumentNullException(nameof(logger));
    }

    public async Task Handle(RandomOrderingWebhookEvent @event) 
    {
