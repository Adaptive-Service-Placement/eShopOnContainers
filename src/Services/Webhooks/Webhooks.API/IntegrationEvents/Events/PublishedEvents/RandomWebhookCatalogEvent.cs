...
public record RandomWebhookCatalogEvent : IntegrationEvent 
{
    ...
    public RandomWebhookCatalogEvent(String eventId, List<int> listOfRandomNumbers, List<String> listOfRandomStrings) 
    {
        EventId = eventId;
