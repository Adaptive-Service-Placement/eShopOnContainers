...
public record RandomWebhookSignalEvent : IntegrationEvent 
{
    ...
    public RandomWebhookSignalEvent(String eventId, List<int> listOfRandomNumbers, List<String> listOfRandomStrings) 
    {
        EventId = eventId;
