...
public record RandomWebhookOrderingEvent : IntegrationEvent 
{
    ...
    public RandomWebhookOrderingEvent(String eventId, List<int> listOfRandomNumbers, List<String> listOfRandomStrings) 
    {
        EventId = eventId;
