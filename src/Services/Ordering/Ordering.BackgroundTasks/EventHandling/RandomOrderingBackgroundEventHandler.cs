namespace Ordering.BackgroundTasks.EventHandling
{
    ...
    public class RandomOrderingBackgroundEventHandler : IIntegrationEventHandler<RandomOrderingBackgroundEvent> 
    {
        private readonly ILogger<RandomOrderingBackgroundEventHandler> _logger;

        public RandomOrderingBackgroundEventHandler(ILogger<RandomOrderingBackgroundEventHandler> logger) 
        {
            _logger = logger ?? throw new System.ArgumentNullException(nameof(logger));
        }

        public async Task Handle(RandomOrderingBackgroundEvent @event) 
        {
