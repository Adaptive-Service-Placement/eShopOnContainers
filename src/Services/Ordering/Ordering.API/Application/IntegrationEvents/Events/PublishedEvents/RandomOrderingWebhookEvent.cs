...
public record RandomOrderingWebhookEvent : IntegrationEvent 
{
    ...
    public RandomOrderingWebhookEvent(String eventId, List<int> listOfRandomNumbers, List<String> listOfRandomStrings) 
    {
        EventId = eventId;
