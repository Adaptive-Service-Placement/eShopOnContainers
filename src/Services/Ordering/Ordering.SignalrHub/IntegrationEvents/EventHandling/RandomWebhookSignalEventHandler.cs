...
public class RandomWebhookSignalEventHandler : IIntegrationEventHandler<RandomWebhookSignalEvent> 
{
    private readonly ILogger<RandomWebhookSignalEventHandler> _logger;

    public RandomWebhookSignalEventHandler(ILogger<RandomWebhookSignalEventHandler> logger) 
    {
        _logger = logger ?? throw new System.ArgumentNullException(nameof(logger));
    }

    public async Task Handle(RandomWebhookSignalEvent @event) 
    {
