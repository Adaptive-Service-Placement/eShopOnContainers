...
public class RandomOrderingSignalEventHandler : IIntegrationEventHandler<RandomOrderingSignalEvent> 
{
    private readonly ILogger<RandomOrderingSignalEventHandler> _logger;

    public RandomOrderingSignalEventHandler(ILogger<RandomOrderingSignalEventHandler> logger) 
    {
        _logger = logger ?? throw new System.ArgumentNullException(nameof(logger));
    }

    public async Task Handle(RandomOrderingSignalEvent @event) 
    {
